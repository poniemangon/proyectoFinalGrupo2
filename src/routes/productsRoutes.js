...
router.post('/store', upload.single('product_image'), productAddValidation, productsController.store); 
...
router.put('/edit/:id', upload.single('product_image'), productEditValidation, productsController.update); 
// carrito
